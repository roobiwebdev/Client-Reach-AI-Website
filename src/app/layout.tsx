...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "ClientReach.ai - AI Workforce for Businesses | Automated Revenue Growth",
    template: "%s | ClientReach.ai",
  },
  description:
    "Transform your business with AI-powered revenue growth and lead generation. Automated outreach, AI receptionist agents, and intelligent lead management to increase revenue without increasing headcount.",
  keywords: [
    "AI lead generation",
    "automated outreach",
    "AI receptionist",
  ...
  twitter: {
    ...
    title: "ClientReach.ai - AI Workforce for Businesses",
    description:
      "Transform your business with AI-powered lead generation and revenue recovery. Increase revenue without increasing headcount.",
