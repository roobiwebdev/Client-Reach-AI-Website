...
export const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-brand-50 via-white to-white dark:from-brand-950 dark:via-dark-bg dark:to-dark-bg pt-24 pb-16 md:pt-56 md:pb-72">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-10 animate-fade-in-up [animation-delay:400ms]">
          From one AI agent to a complete workforce - increase revenue, save
          time, and cut costs without growing your team.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up [animation-delay:600ms]">
          <button
            onClick={openBookingPopup}
            className="w-full sm:w-auto px-8 py-4 bg-brand-500 text-white font-medium rounded-full transition-all shadow-lg shadow-brand-500/30 hover:shadow-xl hover:shadow-brand-500/40 hover:scale-105 flex items-center justify-center gap-2"
          >
